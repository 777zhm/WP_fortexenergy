<?php /* Template Name: Test ukr Template */ ?>
<?php get_header(); ?>

<section class="advantages_section wow fadeInUp" data-wow-delay="1.5s" data-wow-duration="1">
	<div class="container">
		...
		<div class="row justify-content-center text-center">
			<div class="col-md-4 col-sm-6 advantages_item">
				...
				<div>
					<h4 class="advantage_heading"><span class="timer" data-from="0" data-to="5" data-speed="5000" data-refresh-interval="100"></span> Років</h4>
			...
			<div class="col-md-4 col-sm-6 advantages_item">
				...
				<div>
					<h4 class="advantage_heading"><span class="timer" data-from="0" data-to="3" data-speed="5000" data-refresh-interval="100"></span> Роки</h4>
